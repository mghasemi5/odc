# Generated by Django 3.2.25 on 2024-11-23 08:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_id', models.CharField(blank=True, max_length=256, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_time', models.TimeField()),
                ('event_id', models.CharField(blank=True, max_length=256, null=True)),
                ('device', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users_app.device')),
                ('doctor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users_app.doctor')),
            ],
        ),
        migrations.CreateModel(
